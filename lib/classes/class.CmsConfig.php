 ...
 * @author Robert Campbell (calguy1000@cmsmadesimple.org)
 */
final class CmsConfig implements \ArrayAccess
{
    /**
     * @ignore
     */
    ...
    private function load_config()
    {
        ...
        'persist_db_conn' => self::TYPE_BOOL, //useless
    ...
    /**
     * Retrieve the global instance of the CmsConfig class
...
//        case 'use_adodb_lite':
        ...
        case 'assets_path':
            $this->_cache[$key] = $this->OffsetGet('root_path').DIRECTORY_SEPARATOR.$this->OffsetGet('assets_dir');
            return $this->_cache[$key];
