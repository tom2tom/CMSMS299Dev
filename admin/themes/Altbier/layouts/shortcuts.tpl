...
<div class="col-auto px-0 shortcuts">
  <ul>
    ...
    <li class="favorites open">
      <span context-menu="Marks" title="{$t}" style="cursor:pointer"><i aria-title="{$t}" class="fas fa-lg fa-bookmark"></i></span>
    </li>
    {/if}
{*
    <li>
        <a href="https://www.cmsmadesimple.org" target="_blank" rel="external">
    ...
    {/if}
*}
    {$my_alerts=$theme->get_my_alerts()}{$num_alerts=count($my_alerts)}{if $num_alerts > 0}
