...
<div id="filterdialog" style="display:none;" title="{$mod->Lang('tpl_filter')|escape:'javascript'}">
  ...
  <div class="hbox flow">
    ...
    <select class="boxchild fill" id="filter_tpl" name="{$actionid}filter_tpl" title="{$mod->Lang('title_filter')}">
  ...
  <div class="hbox flow">
    ...
    <select class="boxchild fill" id="filter_sortby" name="{$actionid}filter_sortby" title="{$mod->Lang('title_sortby')}">
  ...
  <div class="hbox flow">
    ...
    <select class="boxchild fill" id="filter_sortorder" name="{$actionid}filter_sortorder" title="{$mod->Lang('title_sortorder')}">
  ...
  <div class="hbox flow">
    ...
    <select class="boxchild fill" id="filter_limit" name="{$actionid}filter_limit_tpl" title="{$mod->Lang('title_filterlimit')}">
