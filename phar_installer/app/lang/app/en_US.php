...
$lang['edeprecated_enabled'] = 'E_DEPRECATED is enabled in the PHPs error_reporting.  Although this will not prevent CMSMS from operating, it might result in warnings being displayed in the output screen, particularly from older, third party modules';
$lang['estrict_enabled'] = 'E_STRICT is enabled in the PHPs error_reporting. Although this will not prevent CMSMS from operating, it might result in warnings being displayed in the HTML output, particularly from older, third party modules';
...
$lang['fail_curl_extension'] = 'The curl extension was not found. Though not a critical issue, this might cause problems with some third party modules';
...
$lang['fail_func_ziparchive'] = 'ZipArchive functionality was not found.  This might limit functionality';
...
$lang['finished_upgrade_msg'] = 'All done! Please visit the <a href="%s">website frontend</a> and the <a href="%s">Admin panel</a> to verify correct behaviour. You might also need to upgrade some third party modules.<br/><strong>Hint:</strong> Remember to create another backup after verifying correct behaviour.';
