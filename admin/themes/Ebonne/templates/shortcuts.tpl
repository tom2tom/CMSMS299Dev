...
<div id="shortcuts">
    ...
    {if $num_alerts > 0}
      ...
      <span class="icon">
        <a id="alerts" title="{lang('notifications_to_handle2',$num_alerts)}"><svg><use xlink:href="themes/Ebonne/images/navsprite.svg#notice"/></svg></a>
      </span><span class="bubble">{$txt}</span>
    {/if}
    <span class="icon">
      {if isset($module_help_url)}
      <a href="{$module_help_url}" title="{lang('module_help')}"><svg><use xlink:href="themes/Ebonne/images/navsprite.svg#cmsmshelp"/></svg></a>
      {else}
      <a href="https://docs.cmsmadesimple.org/" rel="external" title="{lang('documentationtip')}"><svg><use xlink:href="themes/Ebonne/images/navsprite.svg#cmsmshelp"/></svg></a>
      {/if}
    </span>
    <span class="icon">
      {if isset($site_help_url)}
      <a href="{$site_help_url}" title="{lang('site_support')}"><svg><use xlink:href="themes/Ebonne/images/navsprite.svg#support"/></svg></a>
      {else}
      <a href="https://www.cmsmadesimple.org/support/options/" rel="external" title="{lang('site_support')}"><svg><use xlink:href="themes/Ebonne/images/navsprite.svg#support"/></svg></a>
      {/if}
    </span>
    {if isset($marks)}
    <span class="icon">
      <a href="listbookmarks.php?{$secureparam}" title="{lang('bookmarks')}"><svg><use xlink:href="themes/Ebonne/images/navsprite.svg#mybookmarks"/></svg></a>
    </span>
    {/if}
    <span class="icon">
      <a href="{root_url}/index.php" rel="external" target="_blank" title="{lang('viewsite')}"><svg><use xlink:href="themes/Ebonne/images/navsprite.svg#site"/></svg></a>
    </span>
    <span class="icon">
      {if isset($myaccount)}
