...
use HTMLEditor\Utils;

class HTMLEditor extends CMSModule
{
  ...
  public function GetName() { return 'HTMLEditor'; }
  public function GetVersion(){ return '2.3'; } //same as last-used MicroTiny
...
//abandoned      case CapabilityType::CORE_MODULE:
  ...
  /**
   * Hook function to populate 'centralised' user settings UI
   * @internal
   * @ignore
   * @since 2.3 / CMSMS 3.0
   * @return array
