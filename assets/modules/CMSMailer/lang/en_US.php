...
$lang = [
 ...
 'info_single' => 'When a message has > 1 recipient, send to each of them separately, instead of one message to all of them.<br /> If &quot;Always&quot; is selected, a note will be added to the message sent to CC and BCC addresses, indicating its status as a copy.<br /> If &quot;No-CC/BCC&quot; is selected, a single message will always be sent if there is any CC and/or BCC address.',
