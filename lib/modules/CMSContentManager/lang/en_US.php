...
//'info_editcontent_design' => 'Associating a design with a content page allows the rendering engine to output the proper stylesheets for the page',
...
'copycontent' => 'Copy Content Item', // common?
'critical_error' => '** ERROR **',

'default' => 'Default',
'defaultcontent' => 'Default Page',
'dependencies' => 'Dependencies',
'desc_contentmanager_settings' => 'Adjust settings related to displaying or editing content pages',
...
'err_nomatchingcontent' => 'There does not appear to be any content that matches your criteria',
...
'error_contentlocked' => 'It appears that this content is already locked. Try to refresh this page to see up-to-date information',
'error_contenttype_disallowed' => 'Default content type is also set to \'Disallowed\'',
'error_copy_permission' => 'You do not have permission to copy this content page',
'error_delete_defaultcontent' => 'You cannot delete the default content page',
'error_delete_haschildren' => 'You cannot delete a page that has children',
'error_delete_novalidpages' => 'None of the pages you selected can be deleted at this time',
'error_delete_permission' => 'You do not have permission to delete this content page',
'error_editpage_contenttype' => 'The content type selected is invalid',
'error_editpage_permission' => 'Insufficient permission to edit content pages (or this content page)',
...
'error_movecontent' => 'Could not move content page',
...
'error_setdefault' => 'Could not change the default content page.  This could be a database problem, or a permissions issue.',
...
//'error_splg_name' => 'A valid tag name starts with a letter or underscore, followed by any number of letters, numbers, or underscores.',
...
'go' => 'Go',
'group_desc' => 'Members of this group can manage content',
'group' => 'Group',
...
'help_content_target' => 'A target attribute to use when including this item in the navigation.  A target of _blank will open this page in a new navigator window, or tab.',
'help_content_thumbnail' => 'This field allows you to associate a thumbnail image with the content page.  The images must have already been generated on the website <em>(The FileManager module can generate thumbnails on upload)</em> to a directory specified by the website designer.  The image might optionally be displayed on the page, or used when building a navigation',
...
'help_content_type' => 'The content type controls the overall function of an item.  Some content types are used for building HTML pages, while others are for building links or other navigation functions.',
...
'help_listsettings_namecolumn' => 'The text to be displayed in the &quot;Name&quot; column of the content list view.  Choose either the page title, or menu text',
'help_listsettings_visiblecolumns' => 'Select which columns to display in the content list view.  Note that some functionality might not be available if a column is hidden',
...
'help_pagedflt_design_id' => 'The default design of the new content page.  The design is used to find the stylesheets to use',
'help_pagedflt_extra1' => 'The default value for the Extra Field 1 for newly created content pages',
'help_pagedflt_extra2' => 'The default value for the Extra Field 2 for newly created content pages',
'help_pagedflt_extra3' => 'The default value for the Extra Field 3 for newly created content pages',
...
'help_pagedflt_styles' => 'The default stylesheet(s) to apply to each new content page. TODO',
'help_pagedflt_template_id' => 'The default template to use for each new content page.  The template controls page logic, and what content blocks are visible to the editor',
...
'image' => 'Image',
'info_editcontent_template' => 'Each content page must have a template, and that template must have at least the default <code>{content}</code> block defined within it.  The template does not need to be a page template type',
...
'info_ordercontent' => 'Drag and drop rows or groups of rows to change their position in the content tree. <strong>Note:</strong> Some content items, such as separators, do not accept children',
...
'msg_editpage_success' => 'Content updated',
'msg_lockscleared' => 'Locks cleared',
'msg_lostlock' => 'The lock on this content page has expired and been lost.  You can no longer save changes to this page.  Please return to the content list and re-edit this page.',
...
'parent' => 'Parent',
'perm_add' => 'Add pages',
'perm_manage' => 'Manage all content',
'perm_modify' => 'Modify any page',
'perm_remove' => 'Remove pages',
'perm_reorder' => 'Reorder content',
'postinstall' => 'Content Manager module installed',
'postuninstall' => 'The Content Manager module has been uninstalled.<br /><br />Note: no content has been removed from CMSMS.  You are free to reinstall this module or install an alternate content management module',
'preuninstall' => 'Are you sure you want to uninstall this module?<br />Although uninstalling this module will not destroy any content, it might prevent you from being able to manage the pages of this website.',
'prompt_addcontent' => 'Add new page',
'prompt_alias' => 'Alias',
'prompt_bulk_changeowner' => 'Change Page Ownership',
'prompt_bulk_delete_content' => 'Bulk Delete Content Pages',
...
'prompt_clearlocks' => 'Remove all content locks',
...
'title_contentmanager_settings' => 'Content Manager Settings',
'title_contentmanager' => 'Site Pages',
'title_editpage_apply' => 'Save the changes to this content page, and continue editing',
'title_editpage_cancel' => 'Abandon all unsaved changes to this page, and return to the content list',
'title_editpage_submit' => 'Save the changes to this content page, and return to the content list',
'title_editpage_view' => 'View the current content page (saved changes only)',
...
<ul>
 ...
 <h4>Other functionality</h4>
   <ul>
    ...
    <p><strong>Note:</strong>Selecting many content items, or content items with many descendants, can be very memory- and database-intensive, and slow.</p>
  </li>
  <li>Set Active
  ...
  <li>Set Cachable
    <p>This option sets the selected content items to &quoc;cachable&quot;. This might have different effects based on the site configuration:
      <p>
        <p>If enabled in &quot;Site Admin >> Global Settings&quot;, content items marked as &quot;cachable&quot; can be cached by the browser <em>(this reduces load on your webserver for users visiting the same page frequently).</em>
  ...
  <li>Set Not Cachable
    <p>This option ensures that the selected content items are not cachable.
      <p>
  </li>
  <li>Show In Menu
