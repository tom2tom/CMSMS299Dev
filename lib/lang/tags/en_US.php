...
<h4>What parameters does it take?</h4>
<ul>
 <li><em>(optional)</em>format - Date/Time format using parameters from php's date function. See <a href="http://php.net/date" target="_blank">here</a> for a parameter list and information. If no format is given, it will default to a format similar to 'Jan 01, 2004'.</li>
 <li><em>(optional)</em>withtime - If true append a time-format string to the date, if not already provided for</li>
</ul>
and/or any of Smarty's generic parameters (nocache, assign etc)
EOT
