 ...
 * ========================================================== */
(function(global, $) { "$:nomunge,nomunge:usestrict";
  'use strict';
  ...
  OE.helper = {
    ...
    _isMobileDevice: function() {
      ...
      if(ua.match(devices) && (('ontouchstart' in window) || (navigator.msMaxTouchPoints > 0) || window.DocumentTouch && document instanceof DocumentTouch)) { //TODO what is DocumentTouch?
        return true;
      }
    }
  };
