<?php
namespace TreeFiler\UnifiedArchive\Formats;
...
use TreeFiler\UnifiedArchive\ArchiveEntry;
use TreeFiler\UnifiedArchive\ArchiveInformation;
use TreeFiler\UnifiedArchive\LzwStreamWrapper;
use TreeFiler\UnifiedArchive\UnsupportedOperationException;
