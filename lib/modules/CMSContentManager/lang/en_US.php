...
$lang['confirm_expandall'] = 'Are you sure you want to expand all content?  On large sites this may cause problems.  Please be careful';
...
$lang['confirm_setinactive'] = 'Are you sure you want to make his page inactive? This page will not be viewable, and may affect the behavior of a working website.';
$lang['confirm_steal_lock'] = 'This page is locked.  Although you may steal this lock it is not always a nice thing to do.  The other party may lose valuable content edits.<br /><br />Are you sure you want to continue?';
...
$lang['help_listsettings_visiblecolumns'] = 'Select which columns to display in the content list view.  Note that some functionality may not be available if a column is hidden';
...
$lang['help_pagedflt_contenttype'] = 'The default content type for new pages.  This is useful if using other third party modules that provide optional content editing functionality';
...
$lang['help_page_url'] = 'An alternate URL (relative to the root of your website) that can be used to uniquely identify this page i.e: path/to/mypage.  The page URL is only useful when pretty URLs are enabled.';
