      ...
      <div class="header-top cf">
       ...
       {else}
        ...
        <div style="float:right;">
            ...
            <div>
              {if isset($myaccount)}
               <span class="welcome"><a class="welcome-user" href="myaccount.php?{$secureparam}" title="{lang('myaccount')}">{lang('signed_in',{$user->username})}</a></span>
              {else}
               <span class="welcome">{lang('signed_in',{$user->username})}</span>
              {/if}
              <!-- shortcuts -->
