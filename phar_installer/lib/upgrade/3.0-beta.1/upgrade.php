...
// 6A. Changed site params
// maybe wysiwyg, frontendwysiwyg
$sql = 'UPDATE '.CMS_DB_PREFIX."siteprefs SET sitepref_value='HTMLEditor' WHERE sitepref_value='MicroTiny'";
$db->execute($sql);
//TODO MicroTiny#]]#profile___* to HTMLEditor#]]#profile___* if possible
...
// 12.5
// migrate preferred wysiwyg to HTMLEditor(Summernote)
$sql = 'UPDATE '.CMS_DB_PREFIX."userprefs SET `value`='HTMLEditor' WHERE `value`='MicroTiny'";
$db->execute($sql);
