...
$lang['asc'] = 'Ascending';
$lang['any'] = 'Any';
$lang['attached_stylesheets'] = 'Assigned Stylesheets';
$lang['attached_templates'] = 'Assigned Templates';
...
$lang['error_notemplates'] = 'No Editable Template Found';
...
$lang['help_rm_tpl'] = 'Enabling this option will delete all templates that are assigned to this design, but not assigned to another design.  Use extreme caution when enabling this option.';
$lang['help_rm_css'] = 'Enabling this option will delete all stylesheets that are assigned to this design, but not assigned to another design.  Use extreme caution when enabling this option.';
...
$lang['help_stylesheet_created'] = 'The date and time when this stylesheet was originally created';
$lang['help_stylesheet_modified'] = 'The date and time when this stylesheet was last modified';
$lang['help_stylesheet_multiple_designs'] = 'This stylesheet is assigned to multiple designs';
...
$lang['help_stylesheet_no_designs'] = 'This stylesheet is not assigned to any designs';
...
$lang['help_template_designlist'] = 'Specify the designs (zero or more) that this template is assigned to.  Attaching a template to a design is used for quickly finding templates, and when exporting a design for sharing.  You can select or deselect multiple designs by holding the CTRL button down when clicking';
$lang['help_template_designs'] = 'A template may belong to zero or more designs.  If a template is assigned to a design then that template can be chosen for a content page, or exported with the template to an XML file';
...
<ul>
  ...
  <li>The Stylesheets Tab
    <p>This tab is visible to all admin users with the &quot;Manage Stylesheets&quot; permission. It provides the ability to create, delete, edit, and manage stylesheets.
      <p>
  </li>
...
<ul>
  ...
  <li>Templates:
    <p>This tab allows selecting different templates to associate with the design. You can drag and drop templates between the &quot;Available Templates&quot; list and the &quot;Assigned Templates&quot; list and to order templates within the ones assigned. The order of assigned templates is not significant.</p>
  </li>
  <li>Stylesheets:
    <p>This tab allows selecting different stylesheets to associate with the design. You can drag and drop stylesheets between the &quot;Available Stylesheets&quot; list and the &quot;Assigned Stylesheets&quot; list and to stylesheets within the ones assigned. The order of the assigned stylesheets determines the order that they will be included in the rendered page content for content items of type &quot;Content Page&quot;.</p>
  </li>
  <li>Description:
...
$lang['info_edittemplate_templates_tab'] = 'Here you can specify the template(s) belonging to the design.<br />
Design templates are grouped only for organizational and export purposes. Their order is not significant.<br />
<br />
<b>How to use:</b><br />
Select one or more templates, drag them from Available Templates and drop them in the Assigned Templates box, then hit Apply or Submit.<br />
Remove an assigned template by clicking the corresponding trash icon.';
$lang['info_edittemplate_stylesheets_tab'] = 'Here you can specify the stylesheet(s) belonging to the design.<br />
Design stylesheets are grouped for organizational and export purposes, and to control the appearance of web pages using the design. The sheets\' order within the design determines the order in which they are applied.<br />
<br />
<b>How to use:</b><br />
Select one or more stylesheets, drag them from Available Stylesheets and drop them in the Assigned Stylesheets box, then hit Apply or Submit.<br />
Remove an assigned stylesheet by clicking the corresponding trash icon.';
...
//$lang['info_template_content_file'] = 'If authorized, you can also edit the content of this template by working directly on file <strong>&lt;website root folder&gt;%s</strong>.';
...
$lang['prompt_any'] = 'Any';
$lang['prompt_attached_designs'] = 'This stylesheet has been assigned to these designs';
...
$lang['title_css_designs'] = 'This column lists the design that a stylesheet is assigned to (if any).';
...
$lang['title_tpl_modified'] = 'This column displays the date when the template was last modified';
...
$lang['warning_deletetemplate_attachments'] = 'This design has templates assigned to it.  These templates might be in use on some page or by a module. Deleting these templates, even if they are assigned to no other design, might break an otherwise working site.   Please exercise extreme caution!';
$lang['warning_deletedesign'] = '<strong>Warning:  Use extreme caution.</strong>  Deleting a design might break a functioning website.';
$lang['warning_deletestylesheet_attachments'] = 'This design has stylesheets assigned to it. Template(s) used but not assigned to this design might rely on these stylesheets. Deleting these stylesheets, even if they are assigned to no other design might break an otherwise working site. Please exercise extreme caution!';
$lang['warning_editdesign_nostylesheets'] = 'There is no stylesheet available in the system.';
$lang['warning_edittemplate_nostylesheets'] = 'No stylesheet assigned';
