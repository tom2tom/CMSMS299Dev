...
<div id="filtercssdlg" title="{$mod->Lang('css_filter')}">
  {form_start id='filtercssdlg_form'}{*strip*}
    <input type="hidden" name="{$actionid}submit_filter_css" id="submit_filter_css" value="1"/>
    <table class="responsive">
    <tbody>
    <tr>
      <td><label for="filter_css_design">{$mod->Lang('prompt_design')}:</label></td>
      <td><select name="{$actionid}filter_css_design" id="filter_css_design" title="{$mod->Lang('title_filter_design')}">
        <option value="">{$mod->Lang('any')}</option>
        {html_options options=$design_names selected=$css_filter.design}
      </select></td>
    </tr>
    <tr>
      <td><label for="filter_css_sortby">{$mod->Lang('prompt_sortby')}:</label></td>
      <td><select name="{$actionid}filter_css_sortby" id="filter_css_sortby" title="{$mod->Lang('title_sortby')}">
    ...
    <tr>
      <td><label for="filter_css_sortorder">{$mod->Lang('prompt_sortorder')}:</label></td>
      <td><select name="{$actionid}filter_css_sortorder" id="filter_css_sortorder" title="{$mod->Lang('title_sortorder')}">
    ...
    <tr>
      <td><label for="filter_limit_css">{$mod->Lang('prompt_limit')}:</label></td>
      <td><select name="{$actionid}filter_limit_css" id="filter_limit_css">
