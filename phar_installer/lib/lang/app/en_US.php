...
$lang['info_dbinfo'] = 'CMS Made Simple stores most of its data in a database. A MySQL 5.7+ or compatible database is mandatory. The user specified here must have ALL PRIVILEGES on the specified database to allow creating, dropping and modifying tables, indexes and views.';
