...
$lang['desc_wizard_step3'] = 'Check whether everything is suitable for installing CMSMS';
...
$lang['error_missingconfigvar'] = 'The key &quot;%s&quot; is either missing from or invalid in the config.ini file';
...
$lang['fail_php_version2'] = 'The version of PHP running the site (%s) is not optimal. At least %s is required, but %s or greater is recommended.';
...
$lang['finished_custom_upgrade_msg'] = 'Done!  Please log in to the <a href="%s">site\'s Admin panel</a>, and visit the <a href="%s">frontend</a>, to check that everything is working properly.<br /><strong>Hint:</strong> Now is a good time to create another backup.';
$lang['finished_freshen_msg'] = 'The installation has been freshened! The core files have been updated, and a new config file created.  You can now <a href="%s">visit this website</a> or log in to the <a href="%s">CMSMS Admin panel</a>.';
$lang['finished_install_msg'] = 'All done! You can now <a href="%s">visit the website</a> or log in to the <a href="%s">CMSMS admin panel</a>.';
$lang['finished_upgrade_msg'] = 'All done! Please visit the <a href="%s">website frontend</a> and the <a href="%s">Admin panel</a> to verify correct behavior. You might also need to upgrade some non-core modules.<br/><strong>Hint:</strong> Remember to create another backup after verifying correct behavior.';
