...
$lang['test_smarty_cachelife'] = 'Smarty normally caches the content of frontend requests for 1 hour. That duration may be changed here. Enter a value (in seconds). 0 effectively disables caching. Leave blank to use the default.';
