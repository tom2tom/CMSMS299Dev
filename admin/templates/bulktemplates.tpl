...
<table class="pagetable">
  <thead>
   <tr>
     ...
     <th>{lang_by_realm('layout','prompt_type')}</th>
     <th>{lang_by_realm('layout','prompt_owner')}</th>
...
{if $bulk_op == 'bulk_action_delete'}
  ...
  <div class="pageoverflow">
    <p class="pageinput">
      <input id="check1" type="checkbox" name="check1" value="1" />&nbsp;<label for="check1">{lang_by_realm('layout','confirm_bulk_template_1')}</label><br/>
      <input id="check2" type="checkbox" name="check2" value="1" />&nbsp;<label for="check2">{lang_by_realm('layout','confirm_bulk_template_2')}</label>
    </p>
  </div>
{/if}
