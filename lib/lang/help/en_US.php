...
$lang['settings_login_module'] = 'This allows you to customise the way admin console logins are handled. Instead of the default, a suitable module (if any) may be used.';
...
$lang['siteprefs_sitelogo'] = 'Optional image file, to be displayed on login pages and admin console pages. Enter an absolute or site-relative URL for the file. Typically somewhere in the site\'s uploads folder.';
