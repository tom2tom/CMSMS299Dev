...
<head>
  ...
  <link rel="shortcut icon" href="{$config.admin_url}/themes/Ghostgum/images/favicon/cmsms-favicon.ico" />
  <link rel="stylesheet" type="text/css" href="{$config.admin_url}/themes/Ghostgum/css/style.css{if !empty($lang_dir)}-{$lang_dir}{/if}" />
  {$header_includes}
</head>
