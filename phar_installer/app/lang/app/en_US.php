...
$lang['info_errorlevel_edeprecated'] = 'E_DEPRECATED is a flag for PHP&quot;s error reporting that indicates that warnings should be displayed about code that is using deprecated techniques.  Although the CMSMS core attempts to ensure that we no longer use deprecated techniques, some modules may not.  This setting should be disabled in the PHP configuration';
$lang['info_errorlevel_estrict'] = 'E_STRICT is a flag for PHP&#39;s error reporting which indicates that strict coding standards should be respected. Although the CMSMS core attempts to conform to E_STRICT standards, some modules may not. It is recommended that this setting be disabled in the PHP configuration';
...
$lang['welcome_message'] = 'Welcome! This CMS Made Simple utility allows you to quickly and easily confirm that the website\'s host is compatible with CMSMS, and then to install or upgrade CMSMS.';
