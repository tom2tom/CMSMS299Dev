<?php
/*
Enum-class that identifies some standard module capabilities
...
/**
 * An enum that identifies some 'standard' module capabilities
 *
 * @package CMS
 * @license GPL
 * @see CMSModule::HasCapability
 */
final class CapabilityType extends BasicEnum
{
	/**
	 ...
	 * @since 3.0
	 */
//unused	const CORE_MODULE = 'coremodule';
	...
	/**
	 * A constant indicating that the module sends notices, with a consequent API
	 * @since 3.0
	 */
