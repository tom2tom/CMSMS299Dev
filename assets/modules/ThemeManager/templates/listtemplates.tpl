<table id="tpllist" class="pagetable" style="width:auto;">
 ...
 <tbody>
 {foreach $tplitems as $entry}{cycle values='row1,row2' assign='rowclass'}
  <tr class="{$rowclass}" onmouseover="this.className='{$rowclass}hover';" onmouseout="this.className='{$rowclass}';">
   ...
   <td>{$entry.usage}</td>
   <td>
    <span class="action" context-menu="Template-{$entry.id}">{admin_icon icon='menu.gif' alt='menu' title=$help_menu class='systemicon'}</span>
   </td>
{/strip}
  </tr>
{/foreach}
