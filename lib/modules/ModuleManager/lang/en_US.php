...
'advancedsearch_help' => 'Specify words to include or exclude from the search using a + or -, surround exact phrases with quotes.  i.e:  +red -apple +"some text"',
...
// D
'db_newer' => 'Database Version Newer',
...
'moddescription' => 'A client for the CMS Made Simple&trade; Module Repository. This module allows previewing and installing modules from the CMSMS Forge without the need for ftp-ing, or unzipping archives.  Module XML files are downloaded using REST, integrity verified, and then expanded automatically.',
...
'need_upgrade' => 'Awaiting upgrade',
'newerversion' => 'Newer version installed',
'newer_available' => 'New version available',
...
'status' => 'Status',
'status_db_newer' => 'The version number stored in the database is greater than the one in the module.',
'status_need_upgrade' => 'The upgrade routine needs to be run on this module',
'status_newer_available' => 'A newer version of this module is available in the repository',
'statustext' => 'Status/Action',
'status_installed' => 'This module is currently installed and available for use.',
'submit' => 'Submit',
'success' => 'Success',
...
'title_cantremove' => 'The file system permissions on this module directory do not permit deleting the files',
'title_cantuninstall' => 'Other installed modules depend on this module, therefore you cannot uninstall it at this time.',
...
'title_has_dependants' => 'This module is required because it used by other installed modules, and therefore cannot be uninstalled',
'title_install' => 'Install this module for use in this website',
'title_installation_complete' => 'Installation Process Complete!',
'title_letter' => 'Show modules whose name starts with %s',
'title_missingdeps' => 'This icon indicates a module which cannot be installed or upgraded due to missing dependencies',
'title_missingdeps2' => 'Missing Dependencies',
'title_mm_importxml' => 'Import module from XML',
'title_moduleabout' => 'View the author and changelog information for this module',
'title_moduleactive' => 'Toggle the active state of the module. Inactive modules are not loaded, and cannot be called, however data remains intact',
...
'title_modulesize2' => 'This column displays the size of the module XML file to be downloaded (in kilobytes)',
'title_modulestatus' => 'This column displays the status or actions available for a particular module',
...
'title_uninstall_module' => 'Uninstall Module',
...
'toggle_active' => 'Set this module as active and usable',
'toggle_inactive' => 'Set this module as inactive and unused. No module data will be destroyed',
