...
$lang['edeprecated_enabled'] = 'E_DEPRECATED is enabled in the PHPs error_reporting.  Although this will not prevent CMSMS from operating, it may result in warnings being displayed in the output screen, particularly from older, third party modules';
$lang['estrict_enabled'] = 'E_STRICT is enabled in the PHPs error_reporting. Although this will not prevent CMSMS from operating, it may result in warnings being displayed in the HTML output, particularly from older, third party modules';
...
$lang['fail_php_version2'] = 'The version of PHP running the site (%s) is too low. At least %s is required, and %s or greater is recommended.';
$lang['fail_post_max_size'] = 'The current post max size (%s) is too low. At least %s is required, and %s or greater is recommended, and ensure that it is larger than the upload_max_filesize';
...
$lang['finished_custom_freshen_msg'] = 'The installation has been freshened! The core files have been updated, and a new config file created. Please visit your website to ensure that everything is functioning correctly';
...
$lang['finished_freshen_msg'] = 'The installation has been freshened! The core files have been updated, and a new config file created.  You can now <a href="%s">visit your website</a> or login to the <a href="%s">CMSMS Admin panel</a>.';
$lang['finished_install_msg'] = 'All done! You can now <a href="%s">visit the website</a> or login to the <a href="%s">CMSMS admin panel</a>.';
$lang['finished_upgrade_msg'] = 'All done! Please visit the <a href="%s">website frontend</a> and the <a href="%s">Admin panel</a> to verify correct behaviour. You may also need to upgrade some third party modules.<br/><strong>Hint:</strong> Remember to create another backup after verifying correct behaviour.';
...
$lang['info_open_basedir_session_save_path'] = 'open_basedir is enabled in the site PHP configuration. We could not properly test session capabilities. However, getting to this point in the installation process probably indicates that sessions are working okay.';
...
$lang['info_timezone'] = 'The time zone used in time calculations and time/date displays. Please select the appropriate zone';
...
$lang['pass_php_version'] = 'The PHP version currently configured (%s) does not meet minimum requirements. PHP %s or higher is required';
$lang['pass_php_version2'] = 'The PHP version currently configured (%s) does not meet minimum requirements. PHP %s is the minimum standard, and %s or higher is recommended';
...
$lang['sometests_failed'] = 'We have performed numerous tests of the site\'s current web environment. Although no critical issues were found, we recommend that the following items be corrected before continuing.';
...
$lang['step2_install_dirnotempty2'] = 'The installation folder already contains some files and/or folders.  Although it is possible to install CMSMS here, doing so may corrupt something else already there.  Please double check the contents of this folder.  For reference some of the files are listed below.  Please ensure that this is correct.';
...
$lang['step3_failed'] = 'This installer has performed numerous tests of the site\'s PHP environment, and one or more of those tests have failed. Those errors will need to be rectified before continuing. After that\'s done, click &quot;Retry&quot; below.';
$lang['step3_passed'] = 'This installer has performed numerous tests of the site\'s PHP environment, and they have all passed. This is great news! Although the tests are not an all-encompassing, there should be no difficulty running the core installation of CMSMS.';
$lang['step9_removethis'] = '<strong>Warning</strong> For security, it is important that the installation file be romoved from the root directory of the website, after verification that everything is working as expected.';
$lang['symbol'] = 'Symbol';
...
$lang['warn_post_max_size'] = 'The post max size value is %s, which is above the minimum of %s, however %s is recommended. Also, please ensure that this value is larger than the upload_max_filesize';
...
$lang['welcome_message'] = 'Welcome! This is the CMS Made Simple installer. It allows you to quickly and easily confirm that your web host is compatible with CMSMS and to install or upgrade to the latest version of CMSMS.<br /><br />We know that you will enjoy it.';
