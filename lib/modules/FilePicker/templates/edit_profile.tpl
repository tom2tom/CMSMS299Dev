...
<div class="pageoverflow">
  <label for="profile_name" class="required">* {$mod->Lang('name')}:</label>
...
<div class="pageoverflow">
  <label for="profile_top">{$mod->Lang('topdir')}:</label>
...
<div class="pageoverflow">
  <label for="profile_thumbs">{$mod->Lang('show_thumbs')}:</label>
...
<div class="pageoverflow">
  <label for="profile_canupload">{$mod->Lang('can_upload')}:</label>
...
<div class="pageoverflow">
  <label for="profile_candelete">{$mod->Lang('can_delete')}:</label>
...
<div class="pageoverflow">
  <label for="profile_canmkdir">{$mod->Lang('can_mkdir')}:</label>
