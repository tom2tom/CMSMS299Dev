...
*/
/*
Compressed and encoded letter-frequency table for the passchk class.
Each three letters are a base-95 encoded number representing the chance
that this combination comes next. Subtract the value of ' ' from each of
the three, then ((((first_value * 95) + second_value) * 95) + third_value)
will give you the odds that this pair is grouped together.
The first is "  " (non-alpha chars), then " a", " b", etc. " y", " z", "a ",
"aa", "ab", and so on.
*/
$Frequency_List = <<<'EOS'
