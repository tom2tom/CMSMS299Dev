...
function toString(string $filename, string $media_query = '', string $media_type = '', $root_url, string &$out, array &$params)
{
	...
	elseif( $media_query ) {
		$out .= '<link rel="stylesheet" type="text/css" href="'.$root_url.$filename.'" media="'.$media_query.'" />'.PHP_EOL;
	}
	elseif( $media_type && $media_type != 'all' ) {
		$out .= '<link rel="stylesheet" type="text/css" href="'.$root_url.$filename.'" media="'.$media_type.'" />'.PHP_EOL;
	}
	else {
		$out .= '<link rel="stylesheet" type="text/css" href="'.$root_url.$filename.'" />'.PHP_EOL;
	}
}
