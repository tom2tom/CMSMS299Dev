...
{strip}
{if isset($marksmenu)}
<span context-menu="Marks" class="icon" style="cursor:pointer" title="{_la('bookmarks')}"><svg><use xlink:href="themes/Ghostgum/images/navsprite.svg#mybookmarks"></svg></span>
{/if}
...
<span class="icon">
  {if isset($myaccount)}
   <a href="usersettings.php?{$secureparam}" title="{_la('title_mysettings')}"><svg><use xlink:href="themes/Ghostgum/images/navsprite.svg#mysettings"></svg></a>
  {elseif ($username)}
...
<span class="icon">
  <a href="logout.php?{$secureparam}"{if isset($is_sitedown)} class="outwarn"{/if} title="{_la('logout')}"><svg><use xlink:href="themes/Ghostgum/images/navsprite.svg#logout"></svg></a>
</span>
{/strip}
{/block}
