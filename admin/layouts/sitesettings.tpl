...
{/foreach}
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_sitename' title=$t}
    <div class="pageinput">
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_sitelogo' title=$t}
    <div class="pageinput">
      {$logoselect}
    </div>
  </div>
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_frontendlang' title=$t}
    <div class="pageinput">
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_globalmetadata' title=$t}
{*  <div class="pageinput">
...
*}
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_logintheme' title=$t}
    <div class="pageinput">
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_dateformat' title=$t}
    <div class="pageinput">
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_datetimeformat' title=$t}
    <div class="pageinput">
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_thumbwidth' title=$t}
    <div class="pageinput">
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_thumbheight' title=$t}
    <div class="pageinput">
  ...
  {if !empty($wysiwyg_opts)}
    <div class="pageoverflow">
      ...
      {cms_help realm='help' key='settings_backendwysiwyg' title=$t}
    ...
    <div class="pageoverflow">
      ...
      {cms_help realm='help' key='settings_wysiwygtheme' title=$t}
      <div class="pageinput">
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_frontendwysiwyg' title=$t}
    <div class="pageinput">
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_searchmodule' title=$t}
    <div class="pageinput">
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_login_module' title=$t}
    <div class="pageinput">
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_login_processor' title=$t}<br>
    <div class="pageinput">
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_password_level' title=$t}
    <div class="pageinput">
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_username_settings' title=$t}
    <div class="pageinput">
...
{/foreach}
  ...
  <div class="pagewarn postgap">
    ...
    {cms_help realm='help' key='settings_nosefurl' title=$t}
  </div>
  {/if}
  <div class="pageinput">
    <button type="submit" name="submit" class="adminsubmit icon apply">{_la('apply')}</button>
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_autocreate_url' title=$t}
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_autocreate_flaturls' title=$t}
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_mandatory_urls' title=$t}
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_badtypes' title=$t}
    <div class="pageinput">
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_basicattribs2' title=$t}
    <div class="pageinput">
    <select id="basic_attributes" class="multicolumn" name="basic_attributes[]" multiple="multiple" size="5">
      {html_options options=$all_attributes selected=$basic_attributes}    </select>
    </div>
  </div>
  <div class="pageoverflow">
    {$t=_la('content_imagefield_path')}<label class="pagetext" for="imagefield_path">{$t}:</label>
    {cms_help realm='help' key='settings_imagefield_path' title=$t}
    <div class="pageinput">
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_thumbfield_path' title=$t}
    <div class="pageinput">
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_contentimage_path' title=$t}
    <div class="pageinput">
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_cssnameisblockname' title=$t}
...
{/foreach}
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_enablesitedown' title=$t}
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_sitedownmessage' title=$t}
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_sitedownexcludeadmins' title=$t}
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm='help' key='settings_sitedownexcludes' title=$t}
    <div class="pageinput">
...
{/foreach}
  ...
  <fieldset>
    ...
    <div class="pageoverflow">
      ...
      {cms_help realm='help' key='settings_browsercache' title=$t}
    ...
    <div class="pageoverflow">
      ...
      {cms_help realm='help' key='settings_browsercache_expiry' title=$t}
      <div class="pageinput">
  ...
  <fieldset>
    ...
    <div class="pageoverflow">
      ...
      {cms_help realm='help' key='settings_autoclearcache' title=$t}
      <div class="pageinput">
  ...
  <fieldset>
    ...
    <div class="pageoverflow">
      ...
      {cms_help realm='help' key='settings_smartycachelife' title=$t}
      <div class="pageinput">
      ...
      {cms_help realm='help' key='settings_smarty_cachemodules' title=$t}
      <div class="pageinput">
      ...
      {cms_help realm='help' key='settings_smarty_cacheusertags' title=$t}
      ...
      {cms_help realm='help' key='settings_smartycompilecheck' title=$t}
  ...
  <fieldset>
    ...
    <div class="pageoverflow">
      ...
      {cms_help realm='help' key='settings_lock_timeout' title=$t}
      <div class="pageinput">
    ...
    <div class="pageoverflow">
      ...
      {cms_help realm='help' key='settings_lock_refresh' title=$t}
      <div class="pageinput">
    ...
    <div class="pageoverflow">
      ...
      {cms_help realm='help' key='settings_adminlog_lifetime' title=$t}
      <div class="pageinput">
    ...
    <div class="pageoverflow">
      ...
      {cms_help realm='help' key='settings_login_timeout' title=$t}
      <div class="pageinput">
  ...
  <legend>{_la('jobs_settings')}</legend>
   <div class="pageoverflow">
     ...
     {cms_help realm='help' key='settings_job_frequency' title=$t}
     <div class="pageinput">
   ...
   <div class="pageoverflow">
     ...
     {cms_help realm='help' key='settings_job_timelimit' title=$t}
     <div class="pageinput">
...
{*
   <div class="pageoverflow">
     ...
     {cms_help realm='help' key='settings_job_url' title=$t}
     <div class="pageinput">
 ...
 {if !empty($syntax_opts)}
  <fieldset>
    ...
    <div class="pageoverflow">
      ...
      {cms_help realm='help' key='settings_syntax' title=$t}
      <div class="pageinput">{$t=_la('about')}
      {foreach $syntax_opts as $i=>$one}
       <input type="radio" name="syntaxtype" id="syn{$i}"{if !empty($one->themekey)} data-themehelp-key="{$one->themekey}"{/if} value="{$one->value}"{if !empty($one->checked)} checked{/if}>
       <label for="syn{$i}">{$one->label}</label>
       {if !empty($one->mainkey)}
       <span class="cms_help" data-cmshelp-key="{$one->mainkey}" data-cmshelp-title="{$t} {$one->label}">{$helpicon}</span>
       {/if}{if !$one@last}<br>{/if}
      {/foreach}
      ...
      {cms_help realm='help' key='settings_syntaxtheme' title=$t}
      <div class="pageinput">
 ...
 {/if}
  <fieldset>
    ...
    <div class="pageoverflow">
      ...
      {cms_help realm='help' key='settings_umask' title=$t}
      <div class="pageinput">
    ...
    <div class="pageoverflow">
      ...
      {cms_help realm='help' key='settings_checkversion' title=$t}
...
{if isset($help_url)}
    <div class="pageoverflow">
      ...
      {cms_help realm='help' key='settings_help_url' title=$t}
      <div class="pageinput">
