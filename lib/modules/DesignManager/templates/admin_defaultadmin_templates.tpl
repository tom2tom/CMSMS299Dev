...
<div id="filterdialog" style="display: none;" title="{$mod->Lang('tpl_filter')|escape:'javascript'}">
  ...
  <div class="vbox">
  <div class="hbox flow">
    <div class="boxchild"><label for="filter_tpl">{$mod->Lang('prompt_options')}:</label></div>
    <div class="boxchild fill"><select id="filter_tpl" name="{$actionid}filter_tpl" title="{$mod->Lang('title_filter')}">
      {html_options options=$filter_tpl_options selected=$tpl_filter.tpl}
    </select></div>
  </div>
  <div class="hbox flow">
    <div class="boxchild"><label for="filter_sortby">{$mod->Lang('prompt_sortby')}:</label></div>
    <div class="boxchild fill"><select id="filter_sortby" name="{$actionid}filter_sortby" title="{$mod->Lang('title_sortby')}">
  ...
  <div class="hbox flow">
    <div class="boxchild"><label for="filter_sortorder">{$mod->Lang('prompt_sortorder')}:</label></div>
    <div class="boxchild fill"><select id="filter_sortorder" name="{$actionid}filter_sortorder" title="{$mod->Lang('title_sortorder')}">
  ...
  <div class="hbox flow">
    <div class="boxchild"><label for="filter_limit">{$mod->Lang('prompt_limit')}:</label></div>
    <div class="boxchild fill"><select id="filter_limit" name="{$actionid}filter_limit_tpl" title="{$mod->Lang('title_filterlimit')}">
