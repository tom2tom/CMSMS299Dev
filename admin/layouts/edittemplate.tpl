...
<div class="rowbox">
  <div class="boxchild">
    ...
    <div class="pageoverflow">
      ...
      {cms_help realm='layout' key='help_template_name' title=$t}
      <div class="pageinput">
    ...
    <div class="pageoverflow">
      ...
      {cms_help realm='layout' key='help_tpl_usage' title=$t}
  ...
  {if $tpl.id > 0}
    <div class="pageoverflow">
      ...
      {cms_help realm='layout' key='help_tpl_created' title=$t}
    ...
    <div class="pageoverflow">
      ...
      {cms_help realm='layout' key='help_tpl_modified' title=$t}
...
{tab_start name='template'}
 <div class="pageoverflow">
   ...
   {cms_help realm='layout' key='help_template_contents' title=$t}
   <div class="pageinput">
...
{tab_start name='description'}
 <div class="pageoverflow">
   ...
   {cms_help realm='layout' key='help_template_description' title=$t}
   <div class="pageinput">
...
{if !empty($design_list)}
  <div class="pageoverflow">
    ...
    {cms_help realm='layout' key='help_template_designlist' title=$t}
    <div class="pageinput">
   ...
   {if $can_manage}
     {if !empty($type_list)}
       <div class="pageoverflow postgap">
         ...
         {cms_help realm='layout' key='help_template_type' title=$t}
         <div class="pageinput">
       ...
       <div class="pageoverflow postgap">
         ...
         {cms_help realm='layout' key='help_template_dflt' title=$t}
       ...
       {/if}
     {else}
       <p class="pageinfo postgap">{_ld('layout','info_no_types')}</p>
     {/if}
     <div class="pageoverflow postgap">
       {$t=_ld('layout','prompt_listable')}<label class="pagetext" for="listable">{$t}:</label>
       {cms_help realm='layout' key='help_template_listable' title=$t}
...
{* multi groups allowed
     ...
     <div class="pageoverflow postgap">
       ...
       {cms_help realm='layout' key='help_template_category' title=$t}
       <div class="pageinput">
...
*}
   ...
   <div class="pageoverflow postgap">
     ...
     {cms_help realm='layout' key='help_template_owner' title=$t}
     <div class="pageinput">
   ...
   <div class="pageoverflow">
     ...
     {cms_help realm='layout' key='help_template_addteditors' title=$t}
     <div class="pageinput">
