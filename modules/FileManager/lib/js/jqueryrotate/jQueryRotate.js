 ...
 */
/*!
jqueryrotate v.2.4 <http://jqueryrotate.com>
...
(function ($, window, document) {
  ...
  // reference: https://stackoverflow.com/questions/19999388/check-if-user-is-using-ie
    ...
    _Loader: (function () {
      if (IE)
        return function () {
          ...
          this._vimage.style.top = "0";
          this._vimage.style.left = "0";
    ...
    _animate: function () {
      ...
      if (checkEnd && !this._parameters.animatedGif) {
        ...
        if (this._canvas || this._vimage || this._img) {
          ...
          this._rotate(Math.floor(angle * 10) / 10);
        }
