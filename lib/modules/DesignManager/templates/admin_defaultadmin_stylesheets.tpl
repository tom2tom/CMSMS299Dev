...
$(document).ready(function() {
  ...
  $('a.steal_css_lock').on('click', function() {
    ...
    return confirm({/literal}'{$mod->Lang("confirm_steal_lock")|escape:"javascript"}'{literal});
  });
...
<div id="filtercssdlg" style="display: none;" title="{$mod->Lang('css_filter')}">
  {form_start id='filtercssdlg_form'}{*strip*}
    ...
    <div class="pageoverflow">
      <label for="filter_css_design" class="text-right">{$mod->Lang('prompt_design')}:</label>
      <select name="{$actionid}filter_css_design" id="filter_css_design" title="{$mod->Lang('title_filter_design')}">
        <option value="">{$mod->Lang('any')}</option>
        {html_options options=$design_names selected=$css_filter.design}
      </select>
    </div>
    <div class="pageoverflow">
      <label for="filter_css_sortby" class="text-right">{$mod->Lang('prompt_sortby')}:</label>
      <select name="{$actionid}filter_css_sortby" id="filter_css_sortby" title="{$mod->Lang('title_sortby')}">
    ...
    <div class="pageoverflow">
      <label for="filter_css_sortorder">{$mod->Lang('prompt_sortorder')}:</label>
      <select name="{$actionid}filter_css_sortorder" id="filter_css_sortorder" title="{$mod->Lang('title_sortorder')}">
    ...
    <div class="pageoverflow">
      ...
      <select name="{$actionid}filter_limit_css" id="filter_limit_css">
