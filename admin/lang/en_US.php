...
// B
'back' => 'Back to Menu',
'backendwysiwyg' => 'Default Admin Rich-Text-Editor',
...
'CMSEX_L002' => 'Attempt to delete a lock when it has yet to be saved',
...
'date_format_string_help' => '<em>strftime</em> formatted date format string. See <a href="http://php.net/manual/en/function.strftime.php">php strftime</a> for more information.',
'date_format_string' => 'Date Format String',
'date' => 'Date',
'day' => 'day',
'days' => 'days',
...
'error_passwordrequired' => 'A <b>password</b> is required for SMTP authentication',
...
'event_desc_metadataprerender' => 'Sent from the metadata plugin before any processing has occurrred',
...
'help' => 'Help',
'helpaddtemplate' => '<p>A template is what controls the look and feel of your site\'s content.</p><p>Create the layout here and also add your CSS in the stylesheet section to control the look of your various elements.</p>',
'helplisttemplate' => '<p>Here you can edit, delete, and create templates.</p><p>To create a new template, click on the <u>Add New Template</u> button.</p><p>If you wish to set all content pages to use the same template, click on the <u>Set All Content</u> link.</p><p>If you wish to duplicate a template, click on the <u>Copy</u> icon and you will be prompted to name the new duplicate template.</p>',
...
'main' => 'Main',
'mainmenu' => 'Main Menu',
'maintenance_warning' => 'Website is still in maintenance mode! Are you sure you want to logout now?',
...
'test_smarty_compilecheck' => 'Disabling template-change checks speeds up operation, but if a template is changed, such change will not be displayed until the cache is cleared or times out (normally 1-hour)',
'test' => 'Test',
...
'warning_mail_settings' => 'The website mailer settings have not been configured.  This could interfere with the ability of this website to send email messages. You should go to <a href="%s">Extensions >> CMSMailer</a> and configure the mail settings with the information provided by your host.',
...
'welcome_user' => 'Signed in as', //DEPRECATED - for compability with themes which run on 2.2
...
'wysiwyg_deftheme' => 'Default Theme for Rich-Text Editor',
