...
<div id="useroptions" title="{$mod->Lang('title_userpageoptions')}">
  {form_start action='defaultadmin' id='myoptions_form'}
    ...
    <div class="hbox flow">
      ...
      <select class="boxchild fill" name="{$actionid}pagelimit">
...
{if $can_manage_content}
    ...
    <div class="hbox flow">
      ...
      <select class="boxchild fill" name="{$actionid}filter_type" id="filter_type">
    ...
    <div class="hbox flow filter_fld" id="filter_design">
      ...
      <select class="boxchild fill" name="{$actionid}filter_design">
    ...
    <div class="hbox flow filter_fld" id="filter_template"></div>
      ...
      <select class="boxchild fill" name="{$actionid}filter_template">
    ...
    <div class="hbox flow filter_fld" id="filter_owner">
      ...
      <select class="boxchild fill" name="{$actionid}filter_owner">
    ...
    <div class="hbox flow filter_fld" id="filter_editor">
      ...
      <select class="boxchild fill" name="{$actionid}filter_editor">
        {html_options options=$user_list selected=$expr}
      </select>
    </div>
{/if}
