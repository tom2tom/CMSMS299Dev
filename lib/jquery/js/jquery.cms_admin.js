...
/**
 * @description global data store, populated by ajax at runtime
 */
var cms_data = {};
...
function cms_confirm(msg, title, yestxt, notxt) {
    ...
    if(typeof(yestxt) === 'undefined') yestxt = cms_lang('yes');
    if(typeof(notxt) === 'undefined') notxt = cms_lang('no');
...
/**
 * @description display a popup feedback-dialog (jquery toast)
 * @function
 * @param (String) type One of 'info','warn', 'error','success'
 * @param (Mixed) msg The message(s) to display, string or strings-array
 * @param (String) title An optional title string
 * @param (Object) props Optional extra or over-riding properties for the plugin
