{tab_header name='general' label=_ld('admin','general_settings') active=$tab}
{tab_header name='editcontent' label=_ld('admin','editcontent_settings') active=$tab}
{tab_header name='sitedown' label=_ld('admin','sitedown_settings') active=$tab}
{* tab_header name='mail' label=_ld('admin','mail_settings') active=$tab *}
{tab_header name='advanced' label=_ld('admin','advanced') active=$tab}
{if !empty($externals)}
{tab_header name='external' label=_ld('admin','external_settings') active=$tab}
{/if}
{* +++++ *}
...
{/foreach}
  ...
  <div class="pageoverflow">
    {$t=_ld('admin','sitename')}<label class="pagetext" for="sitename">{$t}:</label>
  ...
  <div class="pageoverflow">
    {$t=_ld('admin','sitelogo')}<label class="pagetext" for="sitelogo">{$t}:</label>
  ...
  <div class="pageoverflow">
    {$t=_ld('admin','frontendlang')}<label class="pagetext" for="frontendlang">{$t}:</label>
  ...
  <div class="pageoverflow">
    {$t=_ld('admin','globalmetadata')}<label class="pagetext" for="globalmetadata">{$t}:</label>
...
*}
  ...
  {if isset($themes)}
  <div class="pageoverflow">
    {$t=_ld('admin','master_admintheme')}<label class="pagetext" for="logintheme">{$t}:</label>
  ...
  {if isset($themes) || !empty($modtheme)}
   ...
   {if !empty($modtheme)}
     <a id="importbtn">{admin_icon icon='import.gif'} {_ld('admin','importtheme')}</a>
    {if count($themes) > 1}
    &nbsp;<a id="deletebtn">{admin_icon icon='delete.gif'} {_ld('admin','deletetheme')}</a>
    {/if}
   {/if}
   {if isset($themes)}
     {if !empty($exptheme)}&nbsp;{/if}
     <a id="exportbtn">{admin_icon icon='export.gif'} {_ld('admin','exporttheme')}</a>
   {/if}
   </div>
  {/if}
  <div class="pageoverflow">
  ...
  <div class="pageoverflow">
    {$t=_ld('admin','thumbnail_width')}<label for="thumbnail_width">{$t}:</label>
  ...
  <div class="pageoverflow">
    {$t=_ld('admin','thumbnail_height')}<label class="pagetext" for="thumbnail_height">{$t}:</label>
  ...
  {if !empty($wysiwyg_opts)}
    <div class="pageoverflow">
      {$t=_ld('admin','backendwysiwyg')}<label class="pagetext">{$t}:</label>
    ...
    <div class="pageoverflow">
      {$t=_ld('admin','wysiwyg_deftheme')}<label class="pagetext" for="wysiwygtheme">{$t}:</label>
  ...
  {/if}
  <div class="pageoverflow">
    {$t=_ld('admin','frontendwysiwyg')}<label class="pagetext" for="frontendwysiwyg">{$t}:</label>
  ...
  <div class="pageoverflow">
    {$t=_ld('admin','search_module')}<label class="pagetext" for="search_module">{$t}:</label>
  ...
  {/if}
  <fieldset>
    <legend>{_ld('admin','credential_settings')}</legend>
  {if $login_modules}
  <div class="pageoverflow">
    {$t=_ld('admin','admin_login_module')}<label class="pagetext" for="login_module">{$t}:</label>
  ...
  <div class="pageoverflow">
    {$t=_ld('admin','admin_login_processor')}<label class="pagetext">{$t}:</label>
  ...
  <div class="pageoverflow">
    {$t=_ld('admin','password_level')}<label class="pagetext" for="passlevel">{$t}:</label>
  ...
  <div class="pageoverflow">
    {$t=_ld('admin','username_settings')}<label class="pagetext" for="unamelevel">{$t}:</label>
...
{if !empty($modtheme)}
<div id="importdlg" title="{_ld('admin','importtheme')}" style="display:none;">
 <form id="importform" action="themeoperation.php{$urlext}" enctype="multipart/form-data" method="post">
  <div class="pageinput">
   <input type="file" id="xml_upload" title="{_ld('admin','help_themeimport')|escape:'javascript'}" name="import" accept="text/xml" />
  </div>
 </form>
</div>
{if isset($themes) && count($themes) > 1}
<div id="deletedlg" title="{_ld('admin','deletetheme')}" style="display:none;">
...
{/if}
{if !empty($exptheme)}
<div id="exportdlg" title="{_ld('admin','exporttheme')}" style="display:none;">
 <form id="exportform" action="themeoperation.php{$urlext}" enctype="multipart/form-data" method="post">
   <div class="pageinput">
   <select title="{_ld('admin','help_themeexport')}" name="export">
     {html_options options=$themes}   </select>
   </div>
 </form>
</div>
...
{/foreach}
  ...
  {if $pretty_urls}
  <div class="pageoverflow">
    {$t=_ld('admin','content_autocreate_urls')}<label class="pagetext" for="create_urls">{$t}:</label>
  ...
  <div class="pageoverflow">
    {$t=_ld('admin','content_autocreate_flaturls')}<label class="pagetext" for="create_flaturls">{$t}:</label>
  ...
  <div class="pageoverflow">
    {$t=_ld('admin','content_mandatory_urls')}<label class="pagetext" for="mandatory_urls">{$t}:</label>
  ...
  {/if}
  <div class="pageoverflow">
    {$t=_ld('admin','disallowed_contenttypes')}<label class="pagetext" for="disallowed_types">{$t}:</label>
  ...
  <div class="pageoverflow">
    {$t=_ld('admin','basic_attributes')}<label class="pagetext" for="basic_attributes">{$t}:</label>
  ...
  <div class="pageoverflow">
    {$t=_ld('admin','content_imagefield_path')}<label class="pagetext" for="imagefield_path">{$t}:</label>
  ...
  <div class="pageoverflow">
    {$t=_ld('admin','content_thumbnailfield_path')}<label class="pagetext" for="thumbfield_path">{$t}:</label>
  ...
  <div class="pageoverflow">
    {$t=_ld('admin','contentimage_path')}<label class="pagetext" for="contentimage_path">{$t}:</label>
  ...
  <div class="pageoverflow">
    {$t=_ld('admin','cssnameisblockname')}<label class="pagetext" for="cssnameisblockname">{$t}:</label>
...
{/foreach}
  ...
  <div class="pageoverflow">
    {$t=_ld('admin','enablesitedown')}<label class="pagetext" for="sitedownnow">{$t}:</label>
  ...
  <div class="pageoverflow">
    {$t=_ld('admin','sitedownmessage')}<label class="pagetext" for="sitedownmessage">{$t}:</label>
    {cms_help 0='help' key='settings_sitedownmessage' title=$t}
    <div class="pageinput">{$textarea_sitedownmessage}</div>
  </div>
  <div class="pageoverflow">
    {$t=_ld('admin','sitedownexcludeadmins')}<label class="pagetext" for="sitedownexcludeadmins">{$t}:</label>
  ...
  <div class="pageoverflow">
    {$t=_ld('admin','sitedownexcludes')}<label class="pagetext" for="sitedownexcludes">{$t}:</label>
    ...
    <div class="pageinput">
      ...
      <br />{_ld('admin','info_sitedownexcludes')}
      <br />
      <strong>{_ld('admin','your_ipaddress')}:</strong>&nbsp;<span style="color:red;">{cms_utils::get_real_ip()}</span>
    </div>
  </div>
  <div class="pageinput pregap">
    <button type="submit" name="submit" class="adminsubmit icon apply">{_ld('admin','apply')}</button>
...
{/foreach}
  ...
  <fieldset>
    <legend>{_ld('admin','browser_cache_settings')}</legend>
    <div class="pageoverflow">
      {$t=_ld('admin','allow_browser_cache')}<label class="pagetext" for="allow_browser_cache">{$t}:</label>
    ...
    <div class="pageoverflow">
      {$t=_ld('admin','browser_cache_expiry')}<label class="pagetext" for="browser_expiry">{$t}:</label>
  ...
  <fieldset>
    <legend>{_ld('admin','server_cache_settings')}</legend>
    <div class="pageoverflow">
      {$t=_ld('admin','autoclearcache2')}<label class="pagetext" for="autoclearcache2">{$t}:</label>
  ...
  <fieldset>
    <legend>{_ld('admin','smarty_settings')}</legend>
    <div class="pageoverflow">
      {$t=_ld('admin','smarty_cachelife')}<label class="pagetext" for="cache_life">{$t}:</label>
      ...
      {$t=_ld('admin','smarty_cachemodules')}<label class="pagetext" for="cachemodules">{$t}:</label>
      ...
      {$t=_ld('admin','smarty_cacheusertags')}<label class="pagetext" for="cacheusertags">{$t}:</label>
      ...
      {$t=_ld('admin','smarty_compilecheck')}<label class="pagetext" for="compilecheck">{$t}:</label>
  ...
  <fieldset>
    <legend>{_ld('admin','duration_settings')}</legend>
    <div class="pageoverflow">
      {$t=_ld('admin','admin_lock_timeout')}<label class="pagetext" for="lock_timeout">{$t}:</label>
    ...
    <div class="pageoverflow">
      {$t=_ld('admin','admin_lock_refresh')}<label class="pagetext" for="lock_refresh">{$t}:</label>
    ...
    <div class="pageoverflow">
      {$t=_ld('admin','adminlog_lifetime')}<label class="pagetext" for="adminlog">{$t}:</label>
 ...
 {if !empty($syntax_opts)}
  <fieldset>
    <legend>{_ld('admin','syntax_editor_settings')}</legend>
    <div class="pageoverflow">
      {$t=_ld('admin','default_editor')}<label class="pagetext">{$t}:</label>
      ...
      {$t=_ld('admin','syntax_editor_deftheme')}<label class="pagetext" for="syntaxtheme">{$t}:</label>
 ...
 {/if}
  <fieldset>
  <legend>{_ld('admin','jobs_settings')}</legend>
   <div class="pageoverflow">
     {$t=_ld('admin','prompt_frequency')}<label  class="pagetext" for="interval">{$t}:</label>
   ...
   <div class="pageoverflow">
     {$t=_ld('admin','prompt_timelimit')}<label class="pagetext" for="timeout">{$t}:</label>
...
{*
   <div class="pageoverflow">
     {$t=_ld('admin','prompt_joburl')}<label class="pagetext" for="url">{$t}:</label>
...
*}
  ...
  <fieldset>
    ...
    <div class="pageoverflow">
      {$t=_ld('admin','global_umask')}<label class="pagetext" for="umask">{$t}:</label>
    ...
    <div class="pageoverflow">
      <div class="pagetext">{_ld('admin','results')}</div>
    ...
    <div class="pageoverflow">
      <div class="pageinput">
        <button type="submit" name="testumask" class="adminsubmit icon do">{_ld('admin','test')}</button>
      </div>
    </div>
    <div class="pageoverflow">
      {$t=_ld('admin','checkversion')}<label class="pagetext" for="checkversion">{$t}:</label>
...
{if isset($help_url)}
    <div class="pageoverflow">
      {$t=_ld('admin','adminhelpurl')}<label class="pagetext" for="help_url">{$t}:</label>
...
<p class="pageinfo">{_ld('admin','external_setdesc')}</p>
