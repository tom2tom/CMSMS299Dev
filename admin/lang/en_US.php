...
'active' => 'Active',
'activetip1' => 'Click to activate',
'activetip2' => 'Click to deactivate',
'add_usrplg' => 'Add User Defined Tag', //title
'add' => 'Add',
'addbookmark' => 'Add bookmark', // link label
'addbookmark2' => 'Add Bookmark', // page title
...
'addthismark' => 'Bookmark This Page', //menu item label
...
'admin_login_module' => 'Authentication Module',
'admin_login_processor' => 'User Authenticator',
...
'adminspecialgroup' => 'Warning: Members of that group automatically have all permissions',
...
'bookmarks' => 'Bookmarks', //see also 'mybookmarks'
...
'confirm_delete_usrplg' => 'Are you sure you want to delete that plugin?',
'confirm_delete_group' => 'Are you sure you want to delete that users-group?',
'confirm_delete_user' => 'Are you sure you want to delete that user account?',
'confirm_edituser' => 'Are you sure you want to apply changes to that user account?',
'confirm_leave' => 'Are you sure you want to leave this page? Any unsaved change(s) will be lost.',
'confirm_set_template_1' => 'Are you sure you want to set all of these pages to use that template?',
'confirm_set_template_2' => 'Yes, I am sure.',
'confirm_set_template_3' => 'Yes, I am <strong>really</strong> sure.',
'confirm_switchuser' => 'Are you sure you want to switch the effective UID to that user?  You will need to log out of the admin console and log in again to resume normal operations under your user account.',
'confirm_togglegroupactive' => 'Are you sure you want to toggle the active state of that group?',
'confirm_toggleuseractive' => 'Are you sure you want to toggle the active state of that user?',
...
'confirmdeletedir' => 'Are you sure you want to delete that directory and all of its contents?',
...
'editbookmark' => 'Edit bookmark', //tip
'editbookmark2' => 'Edit Bookmark', //title
...
'error_no_content_blocks' => 'No content block was detected in that template. Please ensure that you have at least the default {content} block defined in that template',
'error_no_default_content_block' => 'No default content block was detected in that template. Please ensure that you have a {content} tag in the page template.',
...
'info_cookies' => 'Some admin operations use cookies and/or track your IP address, for site-operational purposes only.',
...
'info_user_switch' => 'Temporarily impersonate this user to test console operation as such',
...
'login_timeout' => 'Logins Remembered <em>(days)</em>',
...
'mybookmarks' => 'Bookmarks', //see also 'bookmarks'
...
'no_design' => 'No design is recorded',
...
'nofiles' => 'No File',
'nohelp' => 'Information not available',
...
'send' => 'Send',
//'sendmail_settings' => 'Sendmail Settings', >> Outmailer module
'sendtest' => 'Send',
...
//'smtp_settings' => 'SMTP Settings', >> Outmailer lang
...
'success' => 'Success',
'switchuser' => 'Test console operation as this user',
...
'text_changeowner' => 'Assign selected pages to a different user',
...
'welcome_user' => 'Signed in as', //deprecated since 3.0 For compability with themes which run on 2.2
