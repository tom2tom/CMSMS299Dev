...
'title_bundled' => 'This module is only distributed via the CMSMS installer',
...
'title_deprecated' => 'This module is deprecated (development has stopped and there will be no new release).',
'title_freshupgrade' => 'A later version is available from the repository',
...
'title_missingdeps' => 'This module cannot be installed or upgraded due to missing pre-requisite(s)',
...
//'title_noforge' => 'This module is not (individually at least) present in the CMSMS forge',
...
'title_stagnant' => 'This module is quite old, and there is no later version in the repository',
'title_stale' => 'The age of this version suggests it might or might not work as intended in a current CMSMS system.',
'title_staleupgrade' => 'A later version is in the repository, but that version was released more than 2 years ago, and might not work as originally intended',
...
'title_upgradeable' => 'A newer version of this module is available in the repository',
