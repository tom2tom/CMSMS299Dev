...
{/if}
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm=$_module key='help_dl_chunksize' title=_ld($_module,'prompt_dl_chunksize')}
    <div class="pageinput">
  ...
  <div class="pageoverflow">
    ...
    {cms_help realm=$_module key='help_latestdepends' title=_ld($_module,'latestdepends')}
...
{if !empty($develop_mode)}
  <div class="pageoverflow">
    ...
    {cms_help realm=$_module key='help_allowuninstall' title=_ld($_module,'allowuninstall')}<br>
...
{if isset($disable_caching)}
  <div class="pageoverflow">
    ...
    {cms_help realm=$_module key='help_disable_caching' title=_ld($_module,'prompt_disable_caching')}
