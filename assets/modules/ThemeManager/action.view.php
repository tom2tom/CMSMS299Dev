<?php
/*
View-theme action for CMS Made Simple module: ThemeManager.
...
if (!$this->CheckPermission('View Themes')) { //OR WHATEVER
...
$starter = FormUtils::create_form_start($this, ['id' => $id, 'action' => 'defaultadmin']);
