    ...
    var MG = global.MG = {
        ...
        init: function () {
            var _this = this,
              ...
              $menu = $('#mg_pagemenu'); // topmost ul of the nav elements
...
//            var viewportWidth = $(window).outerWidth();
            if (this.getStorageValue('sidebar-pref') === 'sidebar-off' || viewportWidth <= 992) {
        ...
        toggleSubMenu: function (menu, duration) {
            ...
            $LIs.children('a').on('click activate', function(ev) {
                ...
                $li.addClass('current');
                _this.closeSidebar($('#mg_container'), menu);
                _this.updateDisplay();
                return true;
            });
...
/*      showNotifications: function () {
            ...
            $('.pagewarning .close-warning').on('click activate', function() {
                MG.setStorageValue(key, 'hidden', 60);
            });
