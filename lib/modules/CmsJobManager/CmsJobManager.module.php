<?php
/*
CmsJobManager: a CMS Made Simple module which manages asynchronous and cron jobs.
Copyright (C) 2016-2020 CMS Made Simple Foundation <foundation@cmsmadesimple.org>
Thanks to Robert Campbell and all other contributors from the CMSMS Development Team.

This module is part of CMS Made Simple.
...
You should have received a copy of that license along with
CMS Made Simple. If not, see <https://www.gnu.org/licenses/>.
*/
...
//  protected $nonce;
    ...
    public function GetName() { return 'CmsJobManager'; }
...
//          case CoreCapabilities::TASKS:
    ...
    {
//      $this->nonce = get_csp_token(); //install CSP header, record the nonce for use by actions
    ...
    // AsyncJobManager interface stuff
    ...
    public function begin_async_processing()
    {
        ...
        $t = AppParams::get('joblastrun', 0) + AppParams::get('jobinterval', 5);
        if ($t > time()) {
            error_log('jobman module: too soon to run jobs'."\n", 3, $this->ASYNCLOG);
//            return;
        }
...
*/
        ...
        error_log('jobman module: initial job URL '.$joburl."\n", 3, $this->ASYNCLOG);
