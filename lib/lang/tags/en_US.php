...
'help_function_queue_script' => <<<'EOT'
<h3>What does this do?</h3>
...
'help_function_render_scripts' => <<<'EOT'
<h3>What does this do?</h3>
...
'help_tagcode' => 'Enter PHP code here. Keep in mind that these tags are actually Smarty function plugins.<br />
<ul>
 <li><strong>Note:</strong> the tag code may access some aspects of the <a href=\"https://www.cmsmadesimple.org/APIDOC2_0\">CMSMS API</a> to interact with the system and with modules. System security is paramount.</li>
 <li>Tip: CMSMS variables commonly used in module-actions: $gCms, $config, $db, $smarty will be in scope. Smarty supplies a template-object which will be in scope as $template.</li>
 <li>Tip: parameters passed to the tag e.g. <code>{myudt param1=value1 param2=value2}</code> will be in scope as correspondingly-named variables, as well as members of an associative array $params.</li>
 <li>Tip: when relevant, pass results to Smarty for formatting via the $template->assign() method.</li>
 <li>Tip: otherwise, results generated by the tag are to be returned, not echoed.</li>
