...
class PageDisplayer
{
     ...
     * caches its properties locally. Typically, the object will be retrieved
     * several times, to process different sections of its content.
     ...
     *
     * @param mixed CmsContentType | CmsContentTypePlaceholder $type
     */
    public static function load_page_type($obj)
    {
