...
$lang['modulesnotwritable'] = 'The core modules folder <em>(and/or the uploads folder)</em> is not writeable, if you would like to install modules by uploading an XML file you need ensure that these folders have full read/write/execute permissions (chmod 777).  Safe mode may also be in effect.';
