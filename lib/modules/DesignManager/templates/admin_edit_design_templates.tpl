...
$(document).ready(function() {
  var _manage_templates = {/literal}'{$manage_templates}'{literal};
  var _edit_url = {/literal}'{cms_action_url action=admin_edit_template tpl=xxxx forjs=1}{literal}';
      ...
      $(elements).each(function() {
        ...
        if(_manage_templates) {
          _e = $('<a/>').attr('href', _url)
            ...
            .attr('title', {/literal}'{$mod->Lang("edit_template")}'{literal});
        } else {
          _e = $('<span/>').text(_text);
        }
        $('span', this).remove();
...
<div class="pageoverflow" id="template_sel">
