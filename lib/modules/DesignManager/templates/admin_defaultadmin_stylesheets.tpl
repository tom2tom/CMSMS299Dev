...
<div id="filtercssdlg" style="display:none;" title="{$mod->Lang('css_filter')}">
  {form_start id='filtercssdlg_form'}{*strip*}
    ...
    <div class="hbox flow">
      ...
      <select class="boxchild fill" name="{$actionid}filter_css_design" id="filter_css_design" title="{$mod->Lang('title_filter_design')}">
    ...
    <div class="hbox flow">
      ...
      <select class="boxchild fill" name="{$actionid}filter_css_sortby" id="filter_css_sortby" title="{$mod->Lang('title_sortby')}">
    ...
    <div class="hbox flow">
      ...
      <select class="boxchild fill" name="{$actionid}filter_css_sortorder" id="filter_css_sortorder" title="{$mod->Lang('title_sortorder')}">
    ...
    <div class="hbox flow">
      ...
      <select class="boxchild fill" name="{$actionid}filter_limit_css" id="filter_limit_css">
