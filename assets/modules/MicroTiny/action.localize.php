<?php
/*
Microtiny module action: import TinyMCE files to the website
...
$this->SetPreference('source_url', $this->GetModuleURLPath().'/lib/tinymce');
...
function get_remote_data($url, $post_paramtrs=false, $curl_opts=[])
{
	...
	$headers[] = "Pragma: no-cache TODO DEPRECATED";  $headers[]= "Cache-Control: max-age=0";
