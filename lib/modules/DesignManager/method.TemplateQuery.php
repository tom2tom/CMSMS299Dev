<?php
# DesignManager module method: retrieve template data
...
SELECT tpl_id FROM '.CMS_DB_PREFIX.CmsLayoutTemplate::ADDUSERSTABLE.' WHERE user_id = ?
UNION
...
$templates = CmsLayoutTemplate::load_bulk($out);
