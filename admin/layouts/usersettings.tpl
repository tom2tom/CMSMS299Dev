...
{/foreach}
  ...
  <fieldset>
    ...
    <div class="pageoverflow">
      ...
      {cms_help realm='help' key='user_language' title=$t}
      <div class="pageinput">
      ...
      {cms_help realm='help' key='user_dateformat' title=$t}
      <div class="pageinput">
      ...
      {cms_help realm='help' key='user_datetimeformat' title=$t}
      <div class="pageinput">
  ...
  <fieldset class="pregap">
    ...
    <div class="pageoverflow">
      ...
      {cms_help realm='help' key='user_ce_navdisplay' title=$t}
      <div class="pageinput">
      ...
      {cms_help realm='help' key='user_indent' title=$t}
      <div class="pageinput">
      ...
      {cms_help realm='help' key='user_dfltparent' title=$t}
  ...
  <fieldset class="pregap">
    ...
    <div class="pageoverflow">
     ...
     {else}
      ...
      {cms_help realm='help' key='user_admintheme' title=$t}
      <div class="pageinput">
     ...
     {if !empty($wysiwyg_opts)}
      ...
      {cms_help realm='help' key='settings_wysiwyg' title=$t}
      <div class="pageinput">
      ...
      {cms_help realm='help' key='user_wysiwygtheme' title=$t}
      <div class="pageinput">
     ...
     {if !empty($syntax_opts)}
      ...
      {foreach $syntax_opts as $i=>$one}
       ...
       <label class="pagetext" for="syn{$i}">{$one->label}</label>
       {if !empty($one->mainkey)}
       <span class="cms_help" data-cmshelp-key="{$one->mainkey}" data-cmshelp-title="{$t} {$one->label}">{$helpicon}</span>
       {/if}<br>
      {/foreach}
      ...
      {cms_help realm='help' key='user_syntaxtheme' title=$t}
      <div class="pageinput">
     ...
     {/if}
      ...
      {cms_help realm='help' key='user_homepage' title=$t}
      <div class="pageinput">
      ...
      {cms_help realm='help' key='user_admincallout' title=$t}
      <div class="pageinput">
      ...
      {cms_help realm='help' key='user_hidehelp' title=$t}
      <div class="pageinput">
