{form_start action=updateoptions id=edit_settings}
  ...
  <div class="pageoverflow postgap">
    ...
    {cms_help realm=$_module key='help_clear_category' title=$label_clear_category}
  ...
  <div class="pageoverflow postgap">
    ...
    {cms_help realm=$_module key='help_timeblock' title=$label_timeblock}
    <div class="pageinput">
  ...
  <div class="pageoverflow postgap">
    ...
    {cms_help realm=$_module key='help_pagelimit' title=$label_article_pagelimit}
    <div class="pageinput">
  ...
  <div class="pageoverflow postgap">
    ...
    {cms_help realm=$_module key='help_summary_wysiwyg' title=$label_summary_wysiwyg}
  ...
  <div class="pageoverflow postgap">
    ...
    {cms_help realm=$_module key='help_email_subject' title=$label_email_subject}
    <div class="pageinput">
  ...
  <div class="pageoverflow postgap">
    ...
    {cms_help realm=$_module key='help_email_to' title=$label_email_to}
    <div class="pageinput">
  ...
  <div class="pageoverflow postgap">
    ...
    {cms_help realm=$_module key='help_email_template' title=$label_email_template}
    <div class="pageinput">
