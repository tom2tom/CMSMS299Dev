...
<div id="filtercssdlg" style="display: none;" title="{$mod->Lang('css_filter')}">
  {form_start id='filtercssdlg_form'}{*strip*}
    ...
    <div class="c_full">
      ...
      <select name="{$actionid}filter_css_design" id="filter_css_design" title="{$mod->Lang('title_filter_design')}" class="grid_9">
    ...
    <div class="c_full">
      ...
      <select name="{$actionid}filter_css_sortby" id="filter_css_sortby" title="{$mod->Lang('title_sortby')}" class="grid_9">
    ...
    <div class="c_full">
      ...
      <select name="{$actionid}filter_css_sortorder" id="filter_css_sortorder" title="{$mod->Lang('title_sortorder')}" class="grid_9">
    ...
    <div class="c_full">
      ...
      <select name="{$actionid}filter_limit_css" id="filter_limit_css" class="grid_9">
