...
<div class="pagecontainer">
  ...
  <div class="pageoverflow">
    ...
    <p class="pageinput">
      <input type="checkbox" name="active" id="active" class="pagecheckbox" value="1"{if $active==1 } checked="checked"{/if} />
      <br />
  ...
  <div class="pageoverflow">
    <p class="pagetext">
      <label for="copyusersettings" title="{lang('info_copyusersettings')}">{lang('copyusersettings')}:</label>
