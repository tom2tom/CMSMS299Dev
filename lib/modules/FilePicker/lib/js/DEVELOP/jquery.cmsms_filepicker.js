...
NO param_inst: string $_SESSION[] key for cached profile object
NO param_extensions: optional rawurlencoded string, comma-separated extensions of files which may be uploaded pending selection
NO param_mime: optional string rawurlencoded mimetype of files which may be uploaded pending selection
*/
(function ($) {
