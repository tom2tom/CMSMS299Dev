...
*/
/*
//TODO remove only if no other filepicker module, hence no potential need for this plugin
$fp = CMS_ADMIN_PATH.DIRECTORY_SEPARATOR.'plugins'.DIRECTORY_SEPARATOR.'function.cms_filepicker.php';
@unlink($fp);
*/
