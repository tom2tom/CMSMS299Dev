...
$lang['apptitle2'] = 'installation and upgrade assistant'; // lowercase version of 'apptitle'
...
$lang['config_writable'] = 'Config file can be saved/modified ?';
...
$lang['desc_wizard_step1'] = 'Provide basic settings for this installer session';
...
$lang['desc_wizard_step4'] = 'For new install or refresh operation, provide basic configuration info';
$lang['desc_wizard_step5'] = 'For new install or refresh operation, provide some basic site details';
...
$lang['error_extract'] = 'Unable to process file %s';
$lang['error_filebad'] = 'Unable to load file %s';
$lang['error_filenotwritable'] = 'The file %s could not be overwritten (permissions problem)'; // see also 'error_overwrite'
...
$lang['error_overwrite'] = 'Permissions problem: cannot overwrite %s'; // see also 'error_filenotwritable'
$lang['error_sendingmail'] = 'Error sending email to initial user';
...
//N/A PHP7+  $lang['fail_magic_quotes_runtime'] = 'It appears that magic quotes are enabled in the host\'s PHP configuration. Please disable them and retry.';
$lang['fail_intl_support'] = 'Internationalisation support (intl extension or equivalent) is not enabled in the host\'s PHP configuration.';
...
$lang['fail_multibyte_support'] = 'Multibyte support (multibyte extension or equivalent) is not enabled in the host\'s PHP configuration';
...
$lang['fail_php_version'] = 'The version of PHP running on the host (%s) is too low. The minimum acceptable version is %s.';
$lang['fail_php_version2'] = 'The version of PHP running on the host (%s) is acceptable, but %s or greater is recommended.';
...
$lang['info_assetspath'] = "Optional substitute for the website system-directory 'assets'. If so desired, enter a website-root-path-relative path e.g. 'hiddenassets' or 'not/here' (without surrounding quotes or leading or trailing separator, and internal separator(s) according with the file system.)";
...
$lang['info_open_basedir_session_save_path'] = 'open_basedir is enabled in the host\'s PHP configuration. Session capabilities could not be properly tested. However, getting to this point in the installation process probably indicates that sessions are working okay.';
$lang['info_plugspath'] = "Optional substitute for the website system-directory 'assets/user_plugins'. If so desired, enter a website-root-path-relative path e.g. 'goodstuff' or 'hackers/cant/findme' (without surrounding quotes or leading or trailing separator, and internal separator(s) according with the file system).";
...
$lang['intl_support'] = 'PHP Internationalization capability is available ?';
...
$lang['multibyte_support'] = 'PHP Multibyte capability is available ?';
...
$lang['prompt_adminpath'] = 'Site Admin-Directory';
$lang['prompt_assetspath'] = 'Site Assets-Directory';
...
$lang['prompt_plugspath'] = 'Site Plugins-Directory';
$lang['prompt_queryvar'] = 'Page-Query Variable';
$lang['prompt_sitename'] = 'Website Name';
...
$lang['send_admin_email'] = 'Send installation-complete email to administrator.<br />No password will be included. <strong>Remember</strong> to securely communicate the password as soon as possible.';
$lang['server_api'] = 'API';
...
$lang['sometests_failed'] = 'The installer has performed numerous tests on the website\'s current PHP environment. Although no critical issues were found, it is recommended that the following items be corrected before continuing.';
...
$lang['step2_install_dirnotempty2'] = 'The installation directory already contains some files and/or directories. Although it is possible to install CMSMS here, doing so might corrupt something else already there. Please double check the contents of this directory. For reference some of the files are listed below. Please ensure that this is correct.';
...
$lang['step3_failed'] = 'The installer has performed numerous tests on the site\'s PHP environment, and one or more of those tests have failed. Those errors will need to be rectified before continuing. After that\'s done, click &quot;Retry&quot; below.';
$lang['step3_passed'] = 'The installer has performed numerous tests on the site\'s PHP environment, and they have all passed. This is great news!';
$lang['step9_removethis'] = '<strong>Warning</strong> For security, it is important that the installation file or directory be removed from the root directory of the website, after verification that everything is working as expected.';
$lang['symbol'] = 'Symbol';
...
// V
$lang['version_writable'] = 'CMSMS version file can be saved/modified ?';

// W
$lang['warn_default_charset'] = 'The host\'s default character-encoding is: %s. A value other than UTF-8 may cause difficulties with text processing in non-english languages.';
