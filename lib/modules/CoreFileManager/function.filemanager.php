<?php
/**
 * Extract of H3K | Tiny File Manager https://github.com/prasathmani/tinyfilemanager
...
/**
 * Scans the files folder recursively, and build a large array
 * @param string $dir
 * @return json
 */
function scan($dir){
...
function php_file_tree_dir($directory, $first_call = true) {
    ...
    foreach($file as $this_file) {
      ...
      if(!in_array($this_file, FM_EXCLUDE_FOLDERS)){
          $dirs[] = $this_file;
      }
    } else {
      $files[] = $this_file;
